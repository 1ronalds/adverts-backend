...
public class SecurityConfiguration {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/admin/isadmin/**").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/application/formine/**").authenticated()
                .antMatchers(HttpMethod.GET, "/application/forothers/**").authenticated()
